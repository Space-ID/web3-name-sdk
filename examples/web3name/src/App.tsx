...
import { createCaName } from "../../../packages/core/src/caName";
...
type Protocol = "EVM" | "Solana" | "Sei" | "Injective" | "Ca";
...
const TEST_CASES: Record<string, TestCase> = {
	...
	ca: {
		...
		address: "inj1xw0d9lcjjnqq4v3lqk8ek9r0cxwpr4s8dxy44h",
		protocol: "Ca",
		description: "Testing ca name resolution with timeout parameter",
	},
};
			...
			switch (currentTest.protocol) {
				case "EVM": {
					...
					switch (currentMethod) {
						case "getAddress":
							resultValue = await web3Name.getAddress(currentTest.domainName, {
